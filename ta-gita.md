...
Halaman Layar Laporan menampilkan data pembayaran pajak dan hasil prediksi keterlambatan dalam bentuk laporan. Admin / Petugas memilih jenis laporan dan menentukan periode data yang akan ditampilkan. Sistem memproses data sesuai dengan jenis dan periode laporan yang dipilih. Sistem menampilkan data pajak dan hasil prediksi secara terstruktur pada halaman laporan. Admin / Petugas dapat memeriksa informasi laporan sebelum melakukan pencetakan. Sistem menyediakan fitur cetak untuk menghasilkan laporan yang dapat digunakan sebagai dokumentasi dan bahan evaluasi. Laporan tersebut juga menyajikan identitas wajib pajak, data kendaraan, tanggal pembayaran, tanggal jatuh tempo, status pembayaran, serta hasil prediksi keterlambatan secara lebih rinci. Admin / Petugas dapat memanfaatkan informasi ini untuk memantau data pembayaran dan mengidentifikasi wajib pajak yang memerlukan perhatian lebih lanjut. Pengelompokan data berdasarkan periode membantu proses perbandingan kondisi pembayaran dari waktu ke waktu. Hasil cetak laporan dapat digunakan sebagai bahan pendukung pengambilan keputusan, dokumentasi kegiatan, dan evaluasi pelayanan pajak. Rancangan layar Cetak Laporan ditampilkan pada Gambar 4. 35.
...
Rancangan Layar Laporan menampilkan rancangan halaman untuk melihat hasil prediksi keterlambatan pembayaran pajak. User dapat melihat data hasil prediksi berdasarkan periode yang dipilih. Sistem menampilkan laporan yang dapat dicetak atau disimpan sesuai kebutuhan. Halaman ini menyediakan pilihan filter untuk menyaring data berdasarkan periode, status pembayaran, dan hasil prediksi. Informasi yang ditampilkan meliputi identitas wajib pajak, data kendaraan, tanggal pembayaran, tanggal jatuh tempo, dan status pembayaran. Hasil prediksi ditampilkan sebagai informasi tambahan untuk membantu User memahami kemungkinan keterlambatan pembayaran. User dapat menggunakan fitur pencarian untuk menemukan data tertentu dengan lebih cepat. Sistem menyusun data secara terstruktur agar laporan mudah dibaca dan dipahami. Dengan adanya halaman ini, User dapat memantau kondisi pembayaran pajak dan menjadikan hasil laporan sebagai bahan evaluasi. Rancangan layar Laporan ditampilkan pada Gambar 4. 36.
...
Rancangan Layar Data Pajak User menampilkan halaman yang digunakan User untuk melihat informasi wajib pajak dan data pembayaran pajak. Sistem menampilkan data seperti identitas wajib pajak, informasi kendaraan, tanggal pembayaran, tanggal jatuh tempo, dan status pembayaran. User dapat melihat data pajak yang tersedia sesuai dengan hak akses yang diberikan oleh sistem. Sistem mengambil data dari basis data dan menampilkan informasi pada halaman Data Pajak. Rancangan Layar Data Pajak User membantu User memperoleh informasi pembayaran pajak secara terstruktur. Halaman ini dilengkapi fitur pencarian agar User dapat menemukan data tertentu berdasarkan nama, nomor polisi, atau identitas wajib pajak. User juga dapat menggunakan filter untuk menampilkan data berdasarkan status pembayaran dan periode tertentu. Dengan tampilan yang terstruktur, proses pemantauan dan pengecekan riwayat pembayaran pajak menjadi lebih mudah dilakukan. Rancangan Layar Data Pajak User ditampilkan pada Gambar 4. 42.
